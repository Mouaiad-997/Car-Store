...
export default class sellcar extends Component {
    ...
    componentDidMount() {
        ...
        axios.get('http://192.168.43.124:8080/api/cars?sold=true', {
            headers: {
    ...
    render() {
                            ...
                            <div class="item-1-contents">
                                ...
                                <ul class="specs">
                                    ...
                                    <li>
                                        ...
                                        <span class="spec">{post.seats}</span>
                                    </li>
                                    <li>
                                        <span style={{ marginRight: '220px' }}>Bayer Name</span>
                                        <span class="spec">{post.buyerName}</span>
                                    </li>
                                    <li>
                                        <span style={{ marginRight: '220px' }}>Sale Price</span>
                                        <span class="spec">{post.salePrice}</span>
                                    </li>
        ...
        return (
            <div className="home">
                ...
                <Link  to={"/home"} type="button" class="btn btn-secondary btn-lg btn-block">Unsold Cars</Link>
